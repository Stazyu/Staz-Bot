...
const wait = async (media) => new Promise(async (resolve, reject) => {
  ...
  try {
    ...
    resolve({
      video: await getBuffer(`https://media.trace.moe/video/${anilist_id}/${encodeURIComponent(filename)}?t=${at}&token=${tokenthumb}`), teks: `${belief()}
~> Ecchi : *${ecch()}*
~> Judul Jepang : *${title}*
...
const banner = cfonts.render(('STAZ BOT'), {
  font: 'block',
  color: 'system',
  align: 'left',
  gradient: ["red", "white"],
...
// get javanesse pasaran By Gimenz
...
module.exports = { wait, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, close, tanggal }
